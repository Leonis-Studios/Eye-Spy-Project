...
const testimonials = [
  {
    quote:
      "The team was professional and had our cameras installed in a single afternoon. Couldn't be happier with the result.",
    name: "James R.",
    location: "Homeowner",
  },
  {
    quote:
      "Finally feel safe at night. They walked us through every option and didn't try to oversell us anything we didn't need.",
    name: "Maria T.",
    location: "Homeowner",
  },
  {
    quote:
      "Got three quotes. SecurTech was the most professional and their price was fair. Highly recommend.",
    name: "David K.",
...
// ─── PAGE ─────────────────────────────────────────────────────────────────────
export default function SecuritySystemsLandingPage() {
          ...
          <div className="relative max-w-6xl mx-auto px-6 md:px-16 py-24 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center w-full">
            ...
            <div className="flex flex-col gap-8">
              ...
              <motion.p
                ...
                style={{ fontFamily: "'Rajdhani', sans-serif" }}
              >
                Licensed & Insured · {siteConfig.serviceArea}
              </motion.p>
