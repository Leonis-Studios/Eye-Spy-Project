...
// ─── PAGE METADATA ────────────────────────────────────────────────────────────
// Each page can export its own metadata to override the layout.tsx defaults.
// This is important for SEO — every page should have a unique title and description.
// NOTE: metadata exports only work in server components (no "use client").
// Since this page uses animations we need "use client", so move this metadata
// to a separate layout.tsx inside app/about/ if you need it — for now the
// layout.tsx default metadata will apply to this page.
...
const team = [
  {
    ...
    bio: "Former licensed electrician turned security specialist. Founded SecurTech after seeing too many homeowners sold systems they didn't need.",
  },
  {
    name: "Rachel T.",
    role: "Project Manager",
    years: "8 years experience",
    bio: "Coordinates every installation from estimate to completion. Makes sure every job runs on time and on budget.",
  },
  {
    name: "Carlos M.",
    role: "Senior Technician",
    years: "10 years experience",
    bio: "Specializes in commercial access control and large-scale camera systems. Certified in Hikvision and Dahua platforms.",
  },
];
...
export default function AboutPage() {
  ...
  return (
    <main className="bg-[#050d1a]">
      {/* ── HERO BANNER ─────────────────────────────────────────────────────── */}
      <section className="relative pt-40 pb-24 overflow-hidden bg-[#050d1a]">
        <div
        ...
        <div className="relative max-w-4xl mx-auto px-6 md:px-16 flex flex-col items-center text-center">
          ...
          >
            {siteConfig.name} was built on a simple belief — every home and
      ...
      >
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            >
              <p>
                {siteConfig.name} started in a garage with one van, one
          ...
          >
            {[
              ...
              { value: siteConfig.stats.years, label: "Years in Business" },
              { value: siteConfig.stats.rating, label: "Average Rating" },
              { value: "100%", label: "Local & Independent" },
            ].map((stat) => (
              <div
                key={stat.label}
                className="bg-[#0a1628] border border-white/5 rounded-sm p-6 flex flex-col gap-2"
              >
                <span
