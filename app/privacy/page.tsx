...
// ─── DATA ─────────────────────────────────────────────────────────────────────
// Each section of the privacy policy as a structured object.
// To update legal language, edit the content strings here.
// Last updated date should be changed any time the policy is modified.
...
We do not use your information for marketing purposes without your explicit consent. We do not sell, rent, lease, or otherwise transfer your personal information to third parties for their marketing purposes.`,
  },
  {
    ...
    content: `In accordance with New York's SHIELD Act (Stop Hacks and Improve Electronic Data Security Act), ${siteConfig.name} implements reasonable administrative, technical, and physical safeguards to protect the personal information we collect. These safeguards include:
      ...
      <section className="relative pt-40 pb-16 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-6 md:px-16">
          ...
          <motion.p
            ...
            style={{ fontFamily: "'DM Sans', sans-serif" }}
          >
            {siteConfig.name} ("we", "us", or "our") is committed to protecting
      ...
      <section className="relative bg-[#050d1a] py-12 overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-6 md:px-16">
          ...
          >
            ...
            not constitute legal advice. {siteConfig.name} recommends consulting
