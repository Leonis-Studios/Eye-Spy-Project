  ...
  return (
    <footer className="relative bg-[#030912] overflow-hidden">
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse, #087ca7 0%, transparent 70%)",
          filter: "blur(40px)",
        }}
        aria-hidden
      />
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center text-slate-500 hover:text-[#68d8d6] hover:border-[#68d8d6]/30 transition-all duration-200"
                aria-label="Facebook"
              >
                <Facebook size={14} />
              </a>
            ...
            <ul className="flex flex-col gap-4">
              <li>
                ...
                >
                  <Phone
                    size={14}
                    className="mt-0.5 shrink-0 text-[#68d8d6]/50 group-hover:text-[#68d8d6] transition-colors duration-200"
                  />
                  <span
                    className="text-sm"
                    style={{ fontFamily: "'DM Sans', sans-serif" }}
              ...
              <li>
                <div className="flex items-start gap-3 text-slate-500">
                  <MapPin
                    size={14}
                    className="mt-0.5 shrink-0 text-[#68d8d6]/50"
                  />
                  <span
