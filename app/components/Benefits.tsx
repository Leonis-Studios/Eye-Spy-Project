  ...
  const itemVariants: Variants = {
    ...
    const benefits: Benefit[] = [
        ...
        },
        {
            ...
            description: "Save hours with our streamlined workflow and automation features."
        },
        {
            icon: <Wrench size={22} />,
            title: "Easy to Use",
    ...
    return(
        <section ref={sectionRef} className="bg-[#080e1d] py-24 overflow-hidden">
            <div className="max-w-6xl mx-auto px-6 md:px-16">
                ...
                style={{fontFamily: "'DM Sans', sans-serif"}}>
                    Everything you need from a security company - done right, the first time. 
                </p>
                <motion.div
                    ...
                    >
                        ...
                        >
                            <div className="group p-6 rounded-sm border border-white/5 hover:border-[#00c8ff]/20 bg-[#0a1628] hover:bg-[#0a1628]/80 transition-all duration-300 h-full">
                                <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-[#00c8ff]/10 text-[#00c8ff] mb-4 group-hover:bg-[#00c8ff]/20 transition-colors duration-300">{benefit.icon}</span>
                                <h3 
                                className="text-lg font-bold text-white mb-2"
                                style={{fontFamily: "'Rajdhani', sans-serif"}}>{benefit.title}</h3>
