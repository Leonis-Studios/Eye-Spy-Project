    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-16 flex flex-col items-center text-center">
        ...
        <div className="relative mt-16">
          <div className="hidden md:block absolute top-8 left-1/4 right-1/4 h-px bg-linear-to-r from-transparent via-[#00c8ff]/30 to-transparent" />
          <motion.div
          ...
          >
            {steps.map((step) => (
              ...
              >
                <div>
                  <span
                    className="text-7xl font-bold text-[#00c8ff]/10 mb-4 block"
                    style={{ fontFamily: "'Rajdhani', sans-serif" }}
                  >
                    {step.step}
                  </span>
